...
func Count(ctx *sqlf.Context, db QueryAble, b SelectBuilder, options ...Option) (int64, error) {
...
func CountColumn(ctx *sqlf.Context, db QueryAble, b SelectBuilder, column sqlf.Builder, options ...Option) (int64, error) {
...
func _count(ctx *sqlf.Context, db QueryAble, b SelectBuilder, column sqlf.Builder, options ...Option) (int64, error) {
